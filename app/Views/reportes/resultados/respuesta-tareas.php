                    ...
                    <div class="card-header">
                        <div class="row g-4 align-items-center">
                            <div class="col-sm-auto">
                                <div>
                                    <h4 class="card-title mb-0 flex-grow-1">Cumplimiento de Tareas (<?= $area['nombre']; ?>)</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table datatable table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php if (!empty($tareas)): ?>
                                        <?php foreach ($tareas as $index => $req): ?>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary" href="<?= base_url() . "tareas/detalle/{$req['id']}"; ?>">
...
<script>
    ...
    if (cumplidos >= incumplidos && cumplidos >= en_proceso) {
        ...
        alertCumplimientoText.innerHTML = ' La mayoría de las Tareas han sido cumplidos a tiempo.';
        ...
        alertCumplimientoText.innerHTML = ' La mayoría de las tareas no se han cumplido dentro del tiempo estipulado.';
    } else {
        ...
        alertCumplimientoText.innerHTML = ' Hay varias Tareas que aún están en proceso.';
    }
</script>
